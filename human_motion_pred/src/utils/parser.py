...
def get_parse(model_name, labels=False, create_params=False):
  ...
  ap.add_argument('-p', '--periods', required=False, help='Number of iterations of the data', default='700', type=int)
  ap.add_argument('-dc', '--decay', required=False, help='Decay', default='0.5', type=float)
  ap.add_argument('-dt', '--decay_times', required=False, help='Number of time to decay the leraning rate.', default='7', type=int)
