...
class R_A_LSTM:
	...
	def make_model(self):
		...
		decode_repete = RepeatVector(self.timesteps-1)
		...
		for i, h in enumerate(self.hierarchies):
			...
			decoded[i] = residual_add(decoded[i], residual[i])
		...
		decoded_ = residual_add(decoded_, residual_)
