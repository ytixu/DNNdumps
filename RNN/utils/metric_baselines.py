...
def compare_label_embedding(model, nn, data_iterator, with_label=True):
	...
	import image
	embedding = metrics.get_label_embedding(model, data_iterator, subspaces=model.hierarchies[-2:])
	print len(embedding)
	...
	for basename in iter_actions():
		...
		np.save('../new_out/R-RNN-t25-l512/RRNN-add-%s.npy'%basename, pose_pred)
		# np.save('../new_out/RRNN-part-%s.npy'%basename, pose_pred_from_part)
...
if __name__ == '__main__':
	...
	plot_results_npy('../', ['../../new_out/R-RNN-t25-l512/npy/RRNN-add-', '../../new_out/R-RNN-t25-l512/npy/RRNN-', '../../new_out/R-RNN-t25-l512/npy/RRNN-part-'], ['Add', 'FN', 'Part'])
