...
def compare_label_embedding(model, nn, data_iterator, with_label=True):
	...
	for basename in iter_actions():
		...
		np.save('../new_out/R-RNN-t25-l512/npy/RRNN-closest-manh-%s.npy'%basename, pose_pred_from_part)
...
if __name__ == '__main__':
	...
	plot_results_npy('../', ['../../new_out/R-RNN-t25-l512/npy/RRNN-' + x for x in ['add-', '', 'part-', 'closest-', 'closest-manh-', 'add-nl-', 'nl-', 'part-nl-', 'closest-nl-', 'closest-nl-manh-']], ['Add-l', 'FN-l', 'Part-l', 'NN-l' 'NN-l-m', 'Add', 'FN', 'Part', 'NN', 'NN-m'])
