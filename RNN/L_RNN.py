...
class L_LSTM:
	...
	def run(self, data_iterator, valid_data):
		...
		# association_evaluation.transfer_motion(self, valid_data, 'sitting', 'greeting', data_iterator)
		association_evaluation.plot_transfer_motion(self, '../new_out/transform/transfer_motion-sitting-to-greeting-scores.npy')
		association_evaluation.plot_transfer_motion(self, '../new_out/transform/transfer_motion-sitting-to-walking-scores.npy')
